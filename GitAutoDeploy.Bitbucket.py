...
class GitAutoDeploy(BaseHTTPRequestHandler):
    ...
    CONFIG_FILEPATH = './GitAutoDeploy.Bitbucket.conf.json'
    config = None
    quiet = False
    daemon = False
    ...
    def parseRequest(self):
        ...
        self.branch = payload['refChanges'][0]['refId'].rsplit('/', 1)[1]
        return [payload['changesets']['values'][0]['links']['self'][0]['href'].split("commits")[0]]
